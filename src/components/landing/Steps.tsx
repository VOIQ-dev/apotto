...
function StepItem({
  ...
  return (
    <div
      ref={ref}
      className={`reveal-on-scroll relative flex gap-4 sm:gap-8 md:gap-12 ${
        isVisible ? "is-visible" : ""
      }`}
    >
      <div className="flex flex-col items-center">
        <div className="relative flex h-10 w-10 sm:h-12 sm:w-12 flex-shrink-0 items-center justify-center rounded-full border-2 border-emerald-200 bg-white text-base sm:text-lg font-bold text-emerald-500 shadow-lg shadow-emerald-200/60 z-10 group">
          {number}
        ...
        {!isLast && (
          <div className="relative h-full w-0.5 bg-slate-200 my-3 sm:my-4 overflow-hidden rounded-full">
            <div className="absolute top-0 left-0 w-full h-1/2 bg-primary animate-draw-line"></div>
          </div>
        )}
      </div>
      <div className="pb-10 sm:pb-16 pt-1 flex-1">
        ...
        {image && (
          <div className="mt-4 sm:mt-6 overflow-hidden rounded-lg sm:rounded-xl border border-slate-200 bg-slate-50 shadow-sm group hover:shadow-md transition-shadow duration-300">
            {image}
          </div>
        )}
      </div>
    ...
    <section id="how-it-works" className="py-16 sm:py-24 bg-white">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        <div className="mb-10 sm:mb-16 text-center">
          ...
          <h2 className="mt-2 text-2xl sm:text-3xl font-bold tracking-tight text-slate-900 md:text-4xl">
            たった3ステップで
            <br />
            アプローチを開始
          </h2>
              ...
              <div className="relative p-6 bg-slate-900/5">
                ...
                <div className="bg-white rounded-lg p-4 shadow-sm text-sm text-slate-700 leading-relaxed border border-slate-200 transform transition-transform group-hover:translate-y-[-4px] duration-300">
                  <p>
                    ...
                    を拝見し、特に〇〇の取り組みに感銘を受けました。弊社のAIツールであれば、その課題をさらに...
                  </p>
                </div>
              </div>
            }
